...
def showRoom(room, policy, allStates, initialState, operations, tranProbMat, finalState):
...
def createImage(imageNum, row, col, c):
    ...
    if imageNum in [0, 1]:
        ...
        strTemp = "gif_pictures/" + COLOR_DICT[imageNum] + ".gif"
        filename = PhotoImage(file="gif_pictures/" + COLOR_DICT[imageNum] + ".gif")
